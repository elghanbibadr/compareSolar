...
const OurServices = () => {
  return (
    <div id="services" className="bg-gradient-to-b from-yellow-400 to-orange-400 p-4 text-darkshadegray pt-16 py-12 rounded-2xl max-w-[1300px] my-8 mx-auto bg-backgroundPaleYellow px-6 py-10rounded-2xl max-w-[1300px] my-8 mx-auto bg-backgroundPaleYellow px-6 py-10 md:py-20">
