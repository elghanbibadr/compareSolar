...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between max-w-[1300px]  md:px-6 mx-auto items-center p-2 md:p-4">
      {/* Logo */}
      <Image
        className=" relative right-6 h-14 sm:h-auto  "
        src={logo}
        alt="solar logo"
        width={200}
        height={100}
      ...
      <div className="">
        <Link href="/questions">
        <button className=" bg-gradient-to-b from-yellow-400 font-medium to-orange-400 md:px-6 rounded-lg p-2 px-4 text-xs md:text-sm tracking--tight text-nowrap capitalize text-white md:text-[1.1rem] md:font-semibold md:py-3  ">
              Compare Solar Now
            </button>
        </Link>
      </div>
