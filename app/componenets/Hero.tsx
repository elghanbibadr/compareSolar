    ...
    <div className="relative hero-wrapper">
      ...
      <div className="relative z-10 md:p-4">
        <div className="flex justify-between p-3 mb-8 items-center">
          ...
          <div>
            <Link href="/questions">
              <button className="focus-visible:outline-2 focus-visible:outline-offset-1 text-white bg-backgroundPaleYellow md:text-[1.1rem] md:font-semibold md:p-4 rounded-[4px]">
                Compare Solar Now
              </button>
            </Link>
          </div>
